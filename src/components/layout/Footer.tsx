      ...
      <div className="section-container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-gray-400">
              Open-source nanophotonics research community
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/research" className="text-sm text-gray-400 hover:text-white transition-colors duration-200">
                  Research
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/community" className="text-sm text-gray-400 hover:text-white transition-colors duration-200">
                  Community
                </Link>
              </li>
              <li>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  ...
                  className="inline-flex items-center gap-2 text-sm text-gray-400 hover:text-[#5865F2] transition-colors duration-200"
                >
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-sm text-gray-400 hover:text-[#FF6719] transition-colors duration-200"
                >
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="mt-12 pt-8 border-t border-dark-700 text-center">
          <p className="text-sm text-gray-500">
            © {new Date().getFullYear()} NSKAILabs. Open source and community-driven.
          </p>
        </div>
      </div>
    </footer>
